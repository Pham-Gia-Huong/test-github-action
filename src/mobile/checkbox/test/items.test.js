...
describe("items constructor set successfully without label prop", function () {
    ...
    it("items constructor set successfully without label prop", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, expect(inputEl.hasAttribute("checked")).to.be.equal(false)];
                case 6:
                    _a.sent();
                    _a.label = 7;
                case 7:
...
describe("throw error when set by constructor", function () {
    ...
    it("have items which is not array", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(function () {
                // @ts-expect-error
                var container = new MobileCheckbox({ items: null });
