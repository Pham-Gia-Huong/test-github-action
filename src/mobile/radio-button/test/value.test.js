        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    isChecked = svgEl.children.length === 3;
                    return [4 /*yield*/, expect(labelEl.innerText).to.be.equal(expectedLabels[i])];
                case 5:
                    _a.sent();
                    if (!(i === 1)) return [3 /*break*/, 7];
                    return [4 /*yield*/, expect(isChecked).to.be.equal(true)];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, expect(isChecked).to.be.equal(false)];
                case 8:
                    _a.sent();
                    _a.label = 9;
                case 9:
...
describe("value constructor set to null successfully", function () {
    var expectedLabels = ["-----", "Orange", "Apple"];
    var expectedValues = ["-----", "orange", "apple"];
    var container = new MobileRadioButton({
        items: [
    ...
    it("value constructor set to null successfully", function () { return __awaiter(void 0, void 0, void 0, function () {
        var el, itemsEl, i, itemEl, labelEl, svgEl, isChecked;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fixture(container)];
