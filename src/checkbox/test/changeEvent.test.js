...
describe("Function change event run successfully by mouse/keyboard event", function () {
    ...
    it("Function change event run successfully by mouse/keyboard event", function () { return __awaiter(void 0, void 0, void 0, function () {
