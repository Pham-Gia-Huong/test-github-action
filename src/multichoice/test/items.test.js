...
describe("items prop set successfully without optional props", function () {
    ...
    var container = new MultiChoice({ items: newitems });
    it("items prop set successfully without optional props", function () { return __awaiter(void 0, void 0, void 0, function () {
...
describe("throw error when default props", function () {
    var expectedLabels = ["Item 1", "Item 2", "Item 3"];
    var expectedValues = ["item-1", "item-2", "item-3"];
    it("item default property is not array", function () { return __awaiter(void 0, void 0, void 0, function () {
...
describe("throw error when item set by props", function () {
    var expectedLabels = ["Item 1", "Item 2", "Item 3"];
    var expectedValues = ["item-1", "item-2", "item-3"];
    it("item property is not array", function () { return __awaiter(void 0, void 0, void 0, function () {
