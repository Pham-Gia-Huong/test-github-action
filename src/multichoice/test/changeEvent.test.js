...
describe("Function Change event run successfully when mousedown", function () {
    ...
    it("Function Change event run successfully when mousedown", function () { return __awaiter(void 0, void 0, void 0, function () {
        var el, itemsEl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    el = _a.sent();
                    itemsEl = el.querySelectorAll(".kuc-multi-choice__menu__item");
                    if (itemsEl.length > 0) {
