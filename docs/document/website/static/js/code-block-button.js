document.addEventListener("DOMContentLoaded", () => {
  const createTabNavEl = (headerEls) => {
  ...
  const createTabSessionEl = (sessionEls) => {
  ...
  const hideActivatedTab = (headerEls, sessionEls) => {
  ...
  const showTabLayout = (containerEl) => {
